...
def well_known_text_to_geometry(
    well_known_text: str, swap_axes: bool = False
) -> Geometry: ...
def well_known_texts_to_geometries(
    well_known_texts: list[str], swap_axes: bool = False
) -> list[Geometry]: ...
